...
<div style="text-align: center">
    <p><b>欢迎注册！</b></p>
    <label><b>用户名 &nbsp;：</b></label><input type="text"name="username"style="border-style: ridge;border-color: red;border-radius: 6px;width: 200px;height: 40px"required="true"placeholder="此项必填"id="username"onchange="validate()"/><br><span id="name"></span>
    <br>
